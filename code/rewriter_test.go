...
func unittest() {
	if ok, val := failpoint.Eval(__failpointName("failpoint-name")); ok {
		fmt.Println("unit-test", val)
	}
}
`,
...
func unittest() {
	if ok, _ := failpoint.Eval(__failpointName("failpoint-name")); ok {
		fmt.Println("unit-test")
	}
}
`,
...
func unittest() {
	if ok, val := failpoint.Eval(__failpointName("failpoint-name"), ctx); ok {
		fmt.Println("unit-test", val)
	}
}
`,
...
func unittest() {
	if ok, val := failpoint.Eval(__failpointName("failpoint-name"), nil); ok {
		fmt.Println("unit-test", val)
	}
}
`,
...
func unittest() {
	if ok, _ := failpoint.Eval(__failpointName("failpoint-name"), nil); ok {
		fmt.Println("unit-test")
	}
}
`,
